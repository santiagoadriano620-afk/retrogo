...
Chunk.prototype.isWithin = function (chunk, distance) {

  /*
   * Function Chunk.isWithin
   * Returns true if the chunk is within a given Chebyshev distance
   */

  return this.position.isWithin(chunk.position, distance);
...
Chunk.prototype.getNumberTilesLayer = function () {
  ...
  // These values are set by the server
  return Chunk.prototype.WIDTH * Chunk.prototype.HEIGHT;
...
Chunk.prototype.__getPositionFromIndex = function (index) {
  ...
  let y = Math.floor((index / Chunk.prototype.WIDTH) % Chunk.prototype.HEIGHT);
  let z = Math.floor(index / (Chunk.prototype.WIDTH * Chunk.prototype.HEIGHT));
