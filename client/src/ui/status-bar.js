...
StatusBar.prototype.STATUS.set(0, { "title": "You are drunk.", "src": "/images/game/states/drunk.png" });
StatusBar.prototype.STATUS.set(1, { "title": "You are poisoned.", "src": "/images/game/states/poisoned.png" });
StatusBar.prototype.STATUS.set(2, { "title": "You are burning.", "src": "/images/game/states/burning.png" });
StatusBar.prototype.STATUS.set(3, { "title": "You are electrified.", "src": "/images/game/states/electrified.png" });
StatusBar.prototype.STATUS.set(4, { "title": "You are invisible.", "src": "/images/game/states/invisible.png" });
...
StatusBar.prototype.STATUS.set(11, { "title": "You are wearing a magic shield.", "src": "/images/game/states/magic_shield.png" });
StatusBar.prototype.STATUS.set(18, { "title": "You are slowed.", "src": "/images/game/states/slowed.png" });
StatusBar.prototype.STATUS.set(14, { "title": "You are hasted.", "src": "/images/game/states/haste.png" });
