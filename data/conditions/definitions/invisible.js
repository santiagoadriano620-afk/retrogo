...
function onStart(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("You have turned invisible.");
...
function onExpire(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("You are visible again.");
