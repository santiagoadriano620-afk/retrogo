...
function onStart(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("You are feeling drunk!");
...
function onExpire(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("You feel sober again!");
