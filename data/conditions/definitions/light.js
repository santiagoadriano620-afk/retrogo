...
function onStart(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("Light surrounds you.");
...
function onExpire(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("The light has dimmed.");
