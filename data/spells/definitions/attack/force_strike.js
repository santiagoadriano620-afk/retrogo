...
module.exports = function forceStrike() {
  ...
  if (!target || target.id === this.id) {
    world.sendMagicEffect(frontPos, CONST.EFFECT.MAGIC.MORTAREA);
    return 200;
  }
  ...
  world.sendMagicEffect(target.position, CONST.EFFECT.MAGIC.MORTAREA);
  return 200;
}
