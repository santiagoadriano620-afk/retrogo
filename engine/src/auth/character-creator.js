...
CharacterCreator.prototype.create = function (name, sex) {
  ...
  if (name === "Admin") {
    ...
    copiedTemplate.properties.availableOutfits = new Array(
      ...
      CONST.LOOKTYPES.MALE.MALE1,
      CONST.LOOKTYPES.MALE.MALE2,
      CONST.LOOKTYPES.MALE.MALE3,
      CONST.LOOKTYPES.MALE.MALE4,
      CONST.LOOKTYPES.FEMALE.FEMALE1,
      CONST.LOOKTYPES.FEMALE.FEMALE2,
      CONST.LOOKTYPES.FEMALE.FEMALE3,
      CONST.LOOKTYPES.FEMALE.FEMALE4
    );
  }
