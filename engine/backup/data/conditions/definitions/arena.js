...
function onExpire(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("You have been rescued.");
...
function onTick(creature) {
  ...
  if (creature.sendCancelMessage) creature.sendCancelMessage("You have %s seconds left.".format(this.numberTicks));
